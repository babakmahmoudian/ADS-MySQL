...
BEGIN
    ...
    -- Note: the nationality_id is retrieved from customer_nationalities
    INSERT INTO customers (
            customer_id, name, nationality_id, email, phoneno
        ) VALUES (
            in_customer_id,
            in_name,
    ...
    INSERT INTO charters (
            charter_id, customer_id, start_date, duration
        ) VALUES (
            in_charter_id,
            in_customer_id,
            in_start_date,
...
/* Business Process 2: Getting the total length of stay at each
   port in a given interval */
...
/* Business Process 3: Getting a list of yachts visiting their home ports
   between two dates */
CREATE VIEW yachts_visiting_home AS
    SELECT yachts.name as "yacht_name",
           visits.date_of_arrival,
...
/* Business Process 4: Retrieving the list of ports visited by a
   given customer */
...
/*  Business Process 5: Temporarily removing a yacht and getting a
    list of inactive yachts
...
BEGIN
    ...
    UPDATE yachts SET inactive_since = (SELECT CURDATE())
                  WHERE name = in_name;
END//
